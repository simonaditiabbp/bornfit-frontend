...
export default function PTSessionInsertPage() {
  ...
  return (
    <div className="max-w-xl mx-auto bg-white p-10 rounded-2xl shadow-lg mt-12 border border-gray-100">
      <h1 className="text-2xl font-bold mb-8 text-blue-700 text-center">Tambah PT Session</h1>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input type="datetime-local" className="w-full border rounded px-3 py-2" value={form.join_date} onChange={e => setForm(f => ({ ...f, join_date: e.target.value }))} required />
        </div>
        <div>
