...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      try {
        ...
        setActionableLists({ expiringSoon, recentlyExpired, inactiveMembers, newMembers });
  ...
  return (
    <div className="p-5 bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      {/* 3 card: aktif & tidak aktif membership */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-5">
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl shadow p-6 flex items-center gap-4">
          ...
          <div>
            <div className="text-lg font-bold text-gray-700 dark:text-gray-300">Active Memberships</div>
        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl shadow p-6 flex items-center gap-4">
          ...
          <div>
            <div className="text-lg font-bold text-gray-700 dark:text-gray-300">Freeze Memberships</div>
        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl shadow p-6 flex items-center gap-4">
          ...
          <div>
            <div className="text-lg font-bold text-gray-700 dark:text-gray-300">Expired / Inactive Memberships</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-5">
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl shadow p-6 flex items-center gap-4">
          ...
          <div>
            <div className="text-lg font-bold text-gray-700 dark:text-gray-300">Conduct PT Today</div>
            <div className="text-3xl font-extrabold text-green-600 dark:text-green-500">{loading ? '-' : stats.conductPTToday}</div>
          </div>
        </div>
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl shadow p-6 flex items-center gap-4">
          ...
          <div>
            <div className="text-lg font-bold text-gray-700 dark:text-gray-300">Active PT Client</div>
            <div className="text-3xl font-extrabold text-amber-600 dark:text-amber-300">{loading ? '-' : stats.activePTClient}</div>
          </div>
        </div>
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl shadow p-6 flex items-center gap-4">
          ...
          <div>
            <div className="text-lg font-bold text-gray-700 dark:text-gray-300">Inactive PT Client</div>
            <div className="text-3xl font-extrabold text-gray-600 dark:text-gray-400">{loading ? '-' : stats.inactivePTClient}</div>
          </div>
        </div>
      </div>
