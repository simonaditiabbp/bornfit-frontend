  ...
  return (
    <div>
        ...
        <nav className="flex" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            <li className="inline-flex items-center">
              <FaChartLine className="w-4 h-4 me-2.5 text-amber-300" /> 
              <span className="ms-1 text-sm font-medium text-gray-200">Revenue Reports</span>
            </li>
          </ol>
        </nav>
      </div>
      ...
      <div className="m-5 p-5 bg-gray-800 border border-gray-700 rounded-lg">
        <h1 className="text-2xl font-bold text-amber-400 mb-6">Revenue Summary</h1>
              ...
              {loading ? (
                ...
                data.map((item) => (
                  <tr key={item.id} className="border-b border-gray-700 hover:bg-gray-750">
                    ...
                    <td className="px-4 py-3 text-right font-semibold text-green-400">{formatCurrency(item.amount)}</td>
                  </tr>
                ))
              )}
            </tbody>
        ...
        <div className="space-y-6">
          <div>
            <h2 className="text-xl font-semibold text-gray-200 mb-3">Download Reports</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="bg-gray-900 p-4 rounded-lg border border-gray-700">
                <h3 className="text-sm font-semibold text-gray-300 mb-2">Membership Revenue</h3>
              ...
              <div className="bg-gray-900 p-4 rounded-lg border border-gray-700">
                <h3 className="text-sm font-semibold text-gray-300 mb-2">Class Purchase Revenue</h3>
                <div className="flex gap-2">
              ...
              <div className="bg-gray-900 p-4 rounded-lg border border-gray-700">
                <h3 className="text-sm font-semibold text-gray-300 mb-2">Daily Revenue</h3>
                <div className="flex gap-2">
